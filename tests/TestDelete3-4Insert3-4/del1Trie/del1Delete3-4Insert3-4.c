...
int main()
{
    ...
    if (fpnEdges == NULL ||fpinsert==NULL || fpdelete==NULL || fpsizedelete==NULL||fpsize==NULL){
    ...
    for ( uint64_t i = 0; i < (nEdges/4)*3; ++i) {
        ...
        if(stop){
            printf("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n");
            break;
        }

...
/*en este experimento primero insertamos 190M de nodos, luego borramos todo, pero vamos calculando cuanto se demora en borrar los ultimos 5M, los ultimos 10M, ..., el arbol completo*/
int main()
{
    ...
    i--;
    for (int k=0;k<39;k++){
        uint64_t msec2 = C[k] * 1000 / CLOCKS_PER_SEC;
        printf("     deleteTime=%lu\n",msec2);
        fprintf(fpdelete,"%lu,\n",msec2);
    }
